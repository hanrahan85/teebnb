...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    console.log('Verification token stored, sending email...');
    ...
    // Try sending with the default Resend address first
    let emailResponse;
    try {
      ...
      // If it's a domain verification error, provide helpful info
      if (resendError.message?.includes('verify a domain')) {
        throw new Error('Email domain not verified. Please verify your domain at resend.com/domains or use your verified email address for testing.');
      }
